 ...
 * 1. Create a free web service on Render.com
 * 2. Set build command: npm install
 * 3. Set start command: node server/torrentProxy.js
 */
...
app.get('/stream', (req, res) => {
  ...
  console.log('[Hayase Proxy] Fetching torrent from Nyaa/Swarm:', magnet.substring(0, 60));
