         ...
         <div className="backdrop-blur-3xl bg-black/40 border border-white/10 rounded-3xl p-8 shadow-[0_0_100px_rgba(220,38,38,0.1)] relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="mb-8 text-center">
                   <div className="inline-flex items-center justify-center p-4 rounded-2xl bg-gradient-to-br from-white/5 to-transparent border border-white/5 shadow-xl mb-4 group-hover:scale-105 transition-transform duration-500">
