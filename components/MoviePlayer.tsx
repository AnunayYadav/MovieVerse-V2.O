...
export const MoviePlayer: React.FC<MoviePlayerProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex flex-col bg-black relative group/player select-none">
       ...
       <div className="absolute top-0 left-0 right-0 z-30 p-4 flex justify-between items-center opacity-0 group-hover/player:opacity-100 transition-opacity duration-300 bg-gradient-to-b from-black/80 to-transparent">
          
          <div className="flex items-center gap-2 ml-12 animate-in fade-in duration-500">
            <button 
            ...
            {isMenuExpanded && (
                <div className="flex items-center gap-2 animate-in slide-in-from-left-2 fade-in duration-300 overflow-hidden">
