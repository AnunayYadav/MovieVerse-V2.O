...
// Fix: Add safeEnv for supabase service
export const safeEnv = (key: string): string => {
    return process.env[key] || "";
};

// Fix: Add formatCurrency for comparison modal
    ...
    return (
      <div 
        ...
        onKeyDown={(e) => {
            ...
            if (e.key === 'KeyE') onToggleWatched(movie); // Quick watched toggle for remotes with keyboard
        }}
      >
