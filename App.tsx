    ...
    return (
        <div ref={rowRef} className="mb-10 animate-in fade-in duration-500">
            ...
            >
                {loading ? (
                    [...Array(6)].map((_, i) => (
                        <div key={i} className="w-[125px] sm:w-[145px] md:w-[150px] shrink-0 aspect-[2/3] bg-zinc-900/45 rounded-xl animate-pulse border border-white/5"></div>
                    ))
                ) : (
                    <>
                        ...
                        {loadingMore && (
                            [...Array(3)].map((_, i) => (
                                <div key={`loadmore-${i}`} className="w-[125px] sm:w-[145px] md:w-[150px] shrink-0 aspect-[2/3] bg-zinc-900/45 rounded-xl animate-pulse border border-white/5 flex items-center justify-center">
                        ...
                        <div className={`relative w-full h-full bg-black overflow-hidden animate-in fade-in duration-500 ${isWatchPartyImmersive ? '' : 'flex flex-col lg:flex-row'}`}>
                            <div className={`bg-black transition-all duration-500 ${isWatchPartyImmersive
                                ...
                                <MoviePlayer
                                    ...
                                    title={watchPartyMovie.title || watchPartyMovie.name}
                                />
                            </div>
                                            ...
                                            <div className="space-y-8">
                                                {!searchQuery && !["People", "Coming", "Collections", "Genres", "Franchise", "Anime", "AnimeCommunity", "Manga", "Watchlist", "Favorites", "History", "Music"].includes(selectedCategory) && !tmdbCollectionId ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <div className={`grid ${searchQuery ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6' : 'grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'} gap-x-4 gap-y-8 animate-in fade-in duration-700`}>
                                                            {movies.map((movie, idx) => (
